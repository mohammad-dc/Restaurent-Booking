...
class _UserDataUpdateDialogState extends State<UserDataUpdateDialog> {
  ...
  void initState(){
    ...
    fname_controller = new TextEditingController(text:widget.initData['first_name']);
    lname_controller = new TextEditingController(text:widget.initData['last_name']);
    mobile_controller = new TextEditingController(text:widget.initData['mobile']);
      ...
      builder: (context, snapshot){
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            style: TextStyle(color: whiteColor, fontFamily: 'Cairo', fontWeight: FontWeight.bold),),
            actions: [
              FlatButton(
                onPressed: () {
